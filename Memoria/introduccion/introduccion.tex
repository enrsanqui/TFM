...
\chapter{Introducción}\LABCHAP{introduccion}
%\epigraph{}{}
...
+\begin{figure}
\centering
\subfloat[Valor de $c_{p}$ cerca del borde de ataque.]{\includegraphics[width=.5\textwidth]{introduccion/figuras/cpBDA.eps}\LABFIG{cpBDA}}
\subfloat[Valor de $\xi$ calculado numéricamente en~\cite{Evangelio2015b}]{\includegraphics[width = .5\textwidth]{introduccion/figuras/cpAlvaro.eps}\LABFIG{cpAlvaro}}++
