...
\begin{figure}
\centering
\subfloat[Velocidad de perturbación adimensional $u'/U_{\infty}$]{\includegraphics[width = .45\textwidth]{upotencial.eps}\LABFIG{upotencial}}
...
\subfloat[Representación de $-C_{p} = -\left(p-p_{\infty}\right)/\left(1/2\rho U_{\infty}^{2}\right)$]{\includegraphics[width = .45\textwidth]{cp.eps}\LABFIG{cp}}
\subfloat[Zoom de $-C_{p}$ en el borde de ataque]{\includegraphics[width=.45\textwidth]{cpZoom.eps}\LABFIG{cpZoom}}
