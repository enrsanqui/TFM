...
\begin{figure}
\centering
\subfloat[Perspectiva 1]{\includegraphics[width = .45\textwidth]{ala2D/figuras/ala2D_1.jpg}}
\hspace{1mm} \subfloat[Perspectiva 2]{\includegraphics[width = .45\textwidth]{ala2D/figuras/ala2D_2.jpg}}
...
\begin{figure}
\centering
\subfloat[Montaje del ala en el túnel]{\includegraphics[width = .45\textwidth]{ala2D/figuras/montajeAla.png}\LABFIG{montajeAla}}\\
\subfloat[Equipo de visualización]{\includegraphics[width = .45\textwidth]{ala2D/figuras/visualizacion.png}\LABFIG{visualizacion}} 
\caption{Montaje experimental completo. En la \FIG{montajeAla} puede apreciarse el sistema de posicionamiento del ala y variación del ángulo de ataque mientras que en la \FIG{visualizacion} se muestra el equipo de visualización.}
...
\item Finalmente, se selecciona una presión interior de las que figuran en la \TAB{parametros2D} y se deja transcurrir un tiempo suficiente hasta alcanzar un régimen estacionario\footnote{Durante la operación experimental este tiempo podía consistir en 20-30s, que es el tiempo que se tardaba en configurar y preparar la cámara para la grabación. Este tiempo es mucho mayor que el tiempo de difusión viscosa $D^{2}/\nu_{g}$  y que el tiempo característico que emplea el gas en recorrer el tubo capilar ($\sim \mathcal{O}(L_{t}/U_{\infty})$, comprobándose esto último en la \SEC{resultados2D}}.
...
\caption{Ejemplo de imágen extraída de uno de los videos realizados a 5000 fps. La imagen muestra un experimento con $\alpha = 8^{\circ}$, $U_{\infty} = $ y $P_{int} = $. %AÑADIR AQUI LOS DATOS DE LA IMAGEN QUE PROCEDA
}
...
Una vez que se han medido los diámetros y las frecuencias de cada terna de parámetros y se dispone del valor de la velocidad empleado en cada una de ellas, se pueden calcular otras variables de interés del problema, como es el caudal total de gas inyectado, obtenido con la \EQ{Qgfreq}
...
\begin{figure}
\centering
\includegraphics[scale=1]{ala2D/figuras/orificioAdverso.jpg}
...
\begin{figure}
\centering
\includegraphics[scale=1]{ala2D/figuras/posicionOrificios.jpg}
...
ciertos orificios pasan de encontrarse en zonas de fuertes gradientes favorables de presión a zonas de gradiente adverso de presión. La posición de los puntos de remanso y los picos de succión ha sido calculada empleando el código de Elementos de Contorno descrito en el \APEN{ApA}
...
\subsection{Influencia de $\mathbf{Q_{g}, U_{\infty},\ \mathrm{y}\ \alpha}$ en $\mathbf{\bar{s} = 0}$}\LABSSEC{resultadosOrificio2D}
...
\begin{figure}
\centering
\subfloat[$P_{int} = 120\,\mathrm{mbar}$]{\includegraphics[width = .45\textwidth]{ala2D/figuras/videoQg2D1.jpg}}\hspace{1mm}
\subfloat[$P_{int} = 700\,\mathrm{mbar}$]{\includegraphics[width = .45\textwidth]{ala2D/figuras/videoQg2D2.jpg}}
...
\begin{figure}
\centering
\subfloat[$U_{\infty} = 0.4\,\mathrm{m/s}$]{\includegraphics[width = .45\textwidth]{ala2D/figuras/videoUinf2D1.jpg}} \hspace{1mm}
\subfloat[$U_{\infty} = 0.7\,\mathrm{m/s}$]{\includegraphics[width = .45\textwidth]{ala2D/figuras/videoUinf2D2.jpg}}
...
\begin{figure}
\centering
\subfloat[$d_{b}$ vs  $Q_{g}$, $U_{\infty} = 0.4\,\mathrm{m/s}$]{\includegraphics[width=.45\textwidth]{ala2D/figuras/dbQgU1.eps}\LABFIG{dbQgU1}}
\hspace{1mm} \subfloat[$d_{b}$ vs $Q_{g}$, $U_{\infty} = 0.7\,\mathrm{m/s}$]{\includegraphics[width=.45\textwidth]{ala2D/figuras/dbQgU2.eps}\LABFIG{dbQgU2}}\\
\subfloat[$f_{b}$ vs $Q_{g}$, $U_{\infty} = 0.4\,\mathrm{m/s}$]{\includegraphics[width=.45\textwidth]{ala2D/figuras/dbQgU1.eps}\LABFIG{fbQgU1}}
\hspace{1mm}  \subfloat[$f_{b}$ vs $Q_{g}$, $U_{\infty} = 0.7\,\mathrm{m/s}$]{\includegraphics[width=.45\textwidth]{ala2D/figuras/dbQgU2.eps}\LABFIG{fbQgU2}}
